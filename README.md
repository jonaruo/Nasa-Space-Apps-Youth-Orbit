...
📚 **Read more in our [Detailed Documentation](./docs/Youth_Orbit_Detailed_Report.pdf)**  
...
- **Flexibility:** Missions can launch from multiple airports near the equator, where orbital efficiency is greatest — including Indonesia’s southern and eastern regions.
...
This approach makes Low Earth Orbit more accessible — not just for governments or major corporations, but also for universities, startups, and emerging space agencies across Southeast Asia.

## Our Vision
Our vision is to establish Southeast Asia’s first fully integrated commercial air-launch system — transforming retired aircraft into vehicles of discovery and building an inclusive future for space access.
...
# 🚀 Future Prospects & Innovation — Youth Orbit
## 🌱 Sustainable Propulsion and Methane Fuel Adoption
...
Methane (CH₄) is increasingly recognized as a next-generation aviation and rocket propellant due to its:
...
In the long term, methane-powered aircraft could replace kerosene-burning fleets, while methane-fueled rockets could support clean orbital launches in collaboration with agencies such as BRIN or international partners inspired by Nasa's data regarding fuel. This transition enables Youth Orbit to pioneer Indonesia’s first environmentally responsible aerospace launch platform.

## 🛩️ Expansion of Air Launch Fleet (PTDI & Regional Collaboration)

To scale operations sustainably, Youth Orbit plans to expand its air-launch fleet through strategic partnerships with PT Dirgantara Indonesia (PTDI) and regional aerospace organizations. PTDI’s proven manufacturing expertise provides a solid foundation for developing launch-ready aircraft platforms based on:
- CN-235 — a medium-range twin-turboprop capable of carrying light suborbital or microsatellite launchers.
- N-219 Nurtanio — a lightweight utility aircraft ideal for atmospheric testing and future suborbital missions.
...
Regional collaboration is also envisioned with GISTDA (Thailand), MYSA (Malaysia), and VAST (Vietnam) — establishing a Southeast Asian Aerospace Innovation Network. This alliance would promote joint R&D in materials science, avionics, and sustainable aircraft modification for future space operations. This initiative creates a self-sustaining and regionally integrated aerospace ecosystem, where Southeast Asian-built aircraft launch Southeast Asian-developed rockets — strengthening the region’s autonomy in access to space.

## 🛰️ Partnership with BRIN for Orbital and Suborbital Research

Youth Orbit aims to deepen cooperation with BRIN’s Rocket Technology Division, renowned for developing the RX-series rockets and experimental sounding vehicles. By combining BRIN’s launch expertise with Youth Orbit’s innovative air-launch platform, the collaboration could:
...
By connecting Southeast Asian and international players, the platform contributes to a more equitable global access to LEO — consistent with NASA’s sustainability and commercialization goals.
